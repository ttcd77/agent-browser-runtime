...
The CLI prints key artifact paths plus the professional workflow, capture status,
artifact kind counts, and handoff read/inspect commands. Use `--json` when an
agent or script needs the full response.
