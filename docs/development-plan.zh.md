...
- Application: storage boundary 已补 quota usage breakdown、Storage Buckets support/bucket summary、cookie partition metadata；下一步继续 CHIPS / partitioned cookie 写入 fixture、Cache/IndexedDB drill-down。
